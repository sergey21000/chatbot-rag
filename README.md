...
- 🛠️ [Стек](#-Стек)
- 🐍 [Установка и запуск через Python (UV)](#-Установка-и-запуск-через-Python)
- 🐍 [Установка и запуск через Python (Pip)(#-Установка-и-запуск-через-Python)
- 🐋 [Установка и запуск через Docker Compose](#-Установка-и-запуск-через-Docker)
...
*Настройка*  
Выбор модели, параметры llama.cpp настраиваются в файле `.env`
